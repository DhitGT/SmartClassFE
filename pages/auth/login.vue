...
<template>
  <div
    class="absolute inset-0 h-screen bg-grid bg-gradient-to-br from-purple-600 via-pink-500 to-red-500 opacity-90 z-0"
  ></div>
  <div class="relative z-10 mx-auto container">
    <div class="min-h-screen flex items-center justify-center p-4">
      <div
        class="bg-white rounded-xl shadow-sm w-full max-w-md overflow-hidden"
      >
