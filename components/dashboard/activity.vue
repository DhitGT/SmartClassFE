<template>
  <div class="flex flex-col-reverse md:flex-row min-w-full gap-4">
    <div class="flex space-x-4 md:w-[50%] p-6 bg-white rounded-lg shadow">
      <div class="flex flex-col w-full justify-start max-h-[50vh] overflow-y-scroll gap-4">
        ...
        <div class="flex items-center">
          <component
            ...
            class="h-6 w-6"
            :class="
              log.type == 'income' ? 'text-teal-500' : 'text-red-500'
            "
          />
          ...
          <div class="w-max flex flex-col">
                ...
                <div class="text-gray-500 text-end text-xs">{{ formatDate(log.created_at) }}</div>
            </div>
          </div>
        </div>
      </div>
