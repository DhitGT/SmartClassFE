<template>
  <div
    class="flex flex-col items-center justify-start p-4 bg-white rounded-lg shadow-md md:min-w-0"
  >
    <div
    ...
    <h2
      v-if="formattedCount"
      class="text-lg md:text-2xl font-semibold self-start"
    >
      {{ formattedCount }}
    </h2>
    ...
    <div
      v-else
      class="h-6 md:h-8 w-full bg-gray-200 animate-pulse rounded"
    ></div>
