<template>
          ...
          <div v-if="showModal" class="fixed inset-0 bg-[#00000028] bg-opacity-50 flex items-center justify-center p-4 z-50">
            <form @submit.prevent="submitEdit" class="bg-white p-4 rounded-lg shadow-md w-96">
              ...
              <div class="mb-4">
                ...
                <input v-model="formData.user.email" type="email" class="w-full border rounded p-2" required />
              </div>
              
              <!-- Password -->
              <div class="mb-4">
                <label class="block text-gray-700">Password</label>
                <input v-model="formData.access_code" type="text" class="w-full border rounded p-2" required />
              </div>
              ...
              <div class="mb-4">
                ...
                <div class="flex items-center border border-gray-300 p-2 rounded-md">
                  ...
                  <select v-model="formData.user.role" class="flex-1 outline-none">
  ...
  import { PencilIcon, BriefcaseIcon, XMarkIcon, UserIcon, PhotoIcon } from "@heroicons/vue/24/outline";
